...
public class SignatureGenieActivity extends AppCompatActivity implements GetResult.MyListener {
    ...
    public void callback(JsonObject result, String callNo) {
        try {
            if (callNo.equalsIgnoreCase("1")) {
                ...
                Toast.makeText(SignatureGenieActivity.this, response.getResponseMsg(), Toast.LENGTH_SHORT).show();
                if (response.getResult().equalsIgnoreCase("true")) {
                    Intent intent = new Intent(SignatureGenieActivity.this, HomeActivity.class);
